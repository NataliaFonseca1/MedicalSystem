...
const MapComponent = () => {
  ...
  useEffect(() => {
    const wmsUrl = 'http://sistemas.gt4w.com.br/geoserver/processo_seletivo/wms?service=WMS&version=1.1.0&request=GetMap&layers=processo_seletivo:ufs_brasil&styles=&bbox=-74.000000,-34.000000,-28.000000,5.000000&width=768&height=330&srs=EPSG:4326&format=application/openlayers';
  ...
  return (
    <MapContainer center={[-15.77972, -47.92972]} zoom={10} style={{ height: '100px', width: '100%' }}>
      <TileLayer
